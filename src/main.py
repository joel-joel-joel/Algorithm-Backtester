...
def main(symbol="AAPL", start="2018-01-01", end="2025-01-01", short_window=50, long_window=200):
    ...
    # Generate charts
    print("\nGenerating charts...")
    plot_price_and_sma(prices, sma_short, sma_long, save_path="results/price_sma.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--short", type=int, default=50, help="Short MA window")
